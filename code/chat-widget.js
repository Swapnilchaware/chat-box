    ...
    class Chatbot {
            ...
            try {
                ...
                const img =  {
                    ...
                    "complex": {
                        ...
                        "data": [
                            {
                                "link": "https://images.pexels.com/photos/37730/sunset-boat-sea-ship-37730.jpeg",
                                "photographer": "Pixabay"
                            },
                            {
                                "link": "https://images.pexels.com/photos/813011/pexels-photo-813011.jpeg",
                                "photographer": "Matthew Barra"
                            }
                        ]
                    },
                    "uuId": "1863b22b-2362-416c-9e5e-4b1193653e78",
                    "requestId": "NewRquestStock-1004"
                }
                ...
                const video = {
                    ...
                    "complex": {
                        ...
                        "data": [
                            {
                                "link": "https://videos.pexels.com/video-files/2943126/2943126-uhd_3840_2160_24fps.mp4"
                            },
                            {
                                "link": "https://videos.pexels.com/video-files/2943126/2943126-uhd_2560_1440_24fps.mp4"
                            },
                            {
                                "link": "https://videos.pexels.com/video-files/854976/854976-uhd_3840_2160_30fps.mp4"
                            },
                            {
                                "link": "https://videos.pexels.com/video-files/854976/854976-uhd_2560_1440_30fps.mp4"
                            }
                        ]
                    },
                    "uuId": "dc57f527-72a4-4fe0-bd11-9844ddb91fea",
                    "requestId": "NewRquestStock-1004"
                }
                ...
                // const data = img; // For testing, replace with video to test video response
                ...
                if (data) {
                    ...
                    if (data.type === "TEXT" && data.text) {
                        ...
                        if (data.complex.metaData.type === "TEXT") {
                            botResponseContent = this.renderMarkdown(data.complex.data.response);
                        }
                    }
        ...
        renderHtmlMenu(menuItems) {
            ...
            menuItems.forEach(item => {
                html += `
                    <li>
                        <a href="${item.url || '#'}" target="_blank" class="menu-link">
