...
document.addEventListener('DOMContentLoaded', function() {
    ...
    class Chatbot {
        ...
        init() {
            ...
            this.userInput.addEventListener('input', () => {
                this.sendButton.disabled = this.userInput.value.trim() === '' && this.uploadedFiles.length === 0;
    ...
    this.sendButton.disabled = this.userInput.value.trim() === '' && this.uploadedFiles.length === 0;
        ...
        async sendMessage() {
            ...
            if (userText === '' && this.uploadedFiles.length === 0) return;
            ...
            // const documentData = `
            //     {
            //         "text": "Here is the response from your document: According to the provided information, the use of credit card information by the Contractor is governed by the following terms:\n\n1. Compliance with Credit Card Company Regulations:\n   - If the services provided by the Contractor access, collect, process, transmit, handle, or store credit card information, the Contractor must ensure compliance with credit card company regulations, provided these regulations do not conflict with any applicable laws in the jurisdiction where the services are provided.\n   - The Contractor must ensure the Software used is Payment Card Industry Data Security Standard (“PCIDSS”) certified.\n   - The Contractor will only use credit card information to deliver the services under the Agreement.\n   - The Contractor will make commercially reasonable efforts to stay informed of any changes to the credit card company regulations during the term of the Agreement.\n\n2. Notification and Compliance:\n   - If at any time the services provided by the Contractor become non-compliant with credit card company regulations, including PCIDSS, the Contractor must promptly notify the Hotel Manager.\n   - The Contractor is required to bring the services into compliance within a reasonable time frame at no additional cost to the Hotel.\n\n3. Audits:\n   - The services, hosting facility, or hosting services used by the Contractor are subject to certain audit requirements either as part of the Hotel Manager’s annual compliance report or due to suspected compromise of credit card information.\n   - The Contractor agrees to permit such audits and provide reasonable cooperation with the applicable credit card company or certified independent auditor during the audit.\n\n4. Security and Confidentiality:\n   - The Contractor is responsible for securing and protecting the confidentiality of credit card information in its possession for as long as the information is maintained, including after termination of the Agreement.\n\n5. Restrictions on Use of Personally Identifiable Information:\n   - The Contractor may not use personally identifiable information (which includes credit card information) to market its services or those of a third party.\n   - The Contractor may not sell or transfer personally identifiable information to third parties.\n   - The Contractor may not otherwise provide third parties with access to personally identifiable information.\n\nIn summary, the Contractor must use credit card information solely for delivering the services, ensure compliance with relevant credit card regulations including PCIDSS certification, notify and remedy any non-compliance promptly, allow audits, safeguard the information securely, and must not use the information for marketing or provide it to third parties.",
            //         "menu": null,
            //         "form": null,
            //         "link": null,
            //         "type": "COMPLEX",
            ...
            //             },
            //             "data": {
            //             "response": "According to the provided information, the use of credit card information by the Contractor is governed by the following terms:\n\n1. Compliance with Credit Card Company Regulations:\n   - If the services provided by the Contractor access, collect, process, transmit, handle, or store credit card information, the Contractor must ensure compliance with credit card company regulations, provided these regulations do not conflict with any applicable laws in the jurisdiction where the services are provided.\n   - The Contractor must ensure the Software used is Payment Card Industry Data Security Standard (“PCIDSS”) certified.\n   - The Contractor will only use credit card information to deliver the services under the Agreement.\n   - The Contractor will make commercially reasonable efforts to stay informed of any changes to the credit card company regulations during the term of the Agreement.\n\n2. Notification and Compliance:\n   - If at any time the services provided by the Contractor become non-compliant with credit card company regulations, including PCIDSS, the Contractor must promptly notify the Hotel Manager.\n   - The Contractor is required to bring the services into compliance within a reasonable time frame at no additional cost to the Hotel.\n\n3. Audits:\n   - The services, hosting facility, or hosting services used by the Contractor are subject to certain audit requirements either as part of the Hotel Manager’s annual compliance report or due to suspected compromise of credit card information.\n   - The Contractor agrees to permit such audits and provide reasonable cooperation with the applicable credit card company or certified independent auditor during the audit.\n\n4. Security and Confidentiality:\n   - The Contractor is responsible for securing and protecting the confidentiality of credit card information in its possession for as long as the information is maintained, including after termination of the Agreement.\n\n5. Restrictions on Use of Personally Identifiable Information:\n   - The Contractor may not use personally identifiable information (which includes credit card information) to market its services or those of a third party.\n   - The Contractor may not sell or transfer personally identifiable information to third parties.\n   - The Contractor may not otherwise provide third parties with access to personally identifiable information.\n\nIn summary, the Contractor must use credit card information solely for delivering the services, ensure compliance with relevant credit card regulations including PCIDSS certification, notify and remedy any non-compliance promptly, allow audits, safeguard the information securely, and must not use the information for marketing or provide it to third parties.",
            //             "documents": [
            //                 {
            //                 "fileName": "1763132-43-07_LetterTemp.pdf",
            //                 "pages": [
            //                     2,
            //                     6,
            //                     7,
            ...
            //             }
            //         },
            //         "uuId": "bda45fe6-14c3-4f37-bb9f-a61531b272ab",
            //         "requestId": "NewRquestStock-1001"
            //         }
            // `;
    ...
    "complex": {
        ...
        "data": {
            "response": "According to the provided information",
            "documents": [
                {
                    "fileName": "1763132-43-07_LetterTemp.pdf",
                    "pages": [
    ...
    "requestId": "NewRquestStock-1001"
       ...
       renderHtmlMenu(menuItems) {
        ...
        //   console.log('positiveButtons', positiveButtons);
        //   console.log('negativeButtons', negativeButtons);
